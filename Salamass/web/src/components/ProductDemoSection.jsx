...
function ProductDemoSection({ labels }) {
  const text = labels || {};
                ...
                <CardContent className="p-0">
                  <div className="grid gap-0 md:min-h-[420px] md:grid-cols-2">
                    ...
                    <div className="flex min-h-[260px] flex-col justify-center bg-card p-8 md:min-h-[420px] md:p-12">
                      ...
                      <h3 className="text-2xl md:text-3xl font-bold mb-4 text-balance">{demo.title}</h3>
                      <p className="text-muted-foreground leading-relaxed text-lg">{demo.description}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
